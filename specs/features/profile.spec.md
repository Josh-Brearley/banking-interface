...
`GET/PUT /api/profile` ([03 §4.5](../03-api-and-data.md#45-profile--profileservicets)).
...
| `PROF-FR-04` | **Save** calls `PUT /api/profile`; shows loading; on success shows confirmation and reflects new values.                                                                                                                                                                                                                                                                       |
